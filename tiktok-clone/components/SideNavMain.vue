...
const isLoggedIn = (sug) => {
  if (!$userStore.id) {
    $generalStore.isLoginOpen = true
    return
  }
  setTimeout(() => router.push(`/profile/${sug.id}`), 200)
}
</script>
...
<template>
  <div id="SideNavMain"
    ...
    <div class="lg:w-full w-[55px] mx-auto">
      ...
      <div v-if="isLoggedIn" v-for="sug in $generalStore.suggested">
      ...
      <div v-if="isLoggedIn" v-for="fol in $generalStore.following">
