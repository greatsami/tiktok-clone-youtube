  ...
  <div id="TopNav" class="fixed bg-white z-30 flex items-center w-full border-b h-[61px]">
    <div
      ...
      <div :class="route.fullPath === '/' ? 'w-[80%]' : 'lg:w-[20%] w-[70%]'">
        <NuxtLink to="/">
          <img src="~/assets/images/tiktok-logo.png" width="115" alt=""/>
        </NuxtLink>
      </div>

      <div class="hidden md:flex items-center bg-[#f1f2f2] p-1 rounded-full max-w-[380px] w-full">
      ...
      <div class="flex items-center justify-end gap-3 min-w-[275px] max-w-[320px] w-full">
        ...
        <div
          ...
          <button class="flex items-center border rounded-md px-3 py-[6px] bg-[#f02c56] text-white">
        ...
        <div
          ...
          <div class="relative">
            <button @click="$event => showMenu = !showMenu" class="mt-1">
              <img :src="$userStore.image" class="rounded-full" width="33"  alt=""/>
            </button>
