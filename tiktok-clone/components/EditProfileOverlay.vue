      ...
      <div class="h-[calc(500px-200px)]" :class="!uploadedImage ? 'mt-16' : 'mt-[58px]'">
        <div v-if="!uploadedImage">
            ...
            <div class="flex items-center justify-center sm:-mt-6">
              <label for="image" class="relative cursor-pointer">
                <img
                    :src="userImage"
                    :alt="$userStore.name"
                    width="95" class="rounded-full">
                <span class="absolute bottom-0 right-0 rounded-full bg-white shadow-xl border p-1 border-gray-300 inline-block w-[32px]">
            ...
            <div class="flex items-center justify-center sm:-mt-6">
              <div class="sm:w-[60%] w-full max-w-md">
                ...
                <div class="text-[11px] text-gray-500 mt-4">
                  ...
                  Change your username will also change your profile link.
                </div>
              </div>
            </div>
          </div>
          ...
          <div id="BioSection" class="flex flex-col sm:h-[120px] px-1.5 py-2 mt-2 w-full">
            ...
            <div class="flex items-center justify-center sm:-mt-6">
              <div class="sm:w-[60%] w-full max-w-md">
                <textarea cols="30" rows="4" v-model="userBio" maxlength="80" class="resize-none w-full bg=[#f1f1f2] text-gray-800 border border-gray-300 rounded-md py-2.5 px-3 focus:outline-none">
                </textarea>
      ...
      >
        <div id="UpdateInfoButtons" v-if="!uploadedImage" class="flex items-center justify-end">
          ...
          <button
              ...
              class="flex items-center border rounded-md text-white ml-3 px-3 py-[6px]">
        ...
        <div id="CropperButtons" v-else class="flex items-center justify-end">
          ...
          <button
              ...
              class="flex items-center border rounded-md bg-[#f02c56] text-white ml-3 px-3 py-[6px]">
            <span class="px-2 font-medium text-[15px]">Apply</span>
          </button>
        </div>
...
const cropAndUpdateImage = async () => {
  ...
  try {
    ...
    await $generalStore.updateSideMenuImage($generalStore.suggested, $userStore)
    await $generalStore.updateSideMenuImage($generalStore.following, $userStore)
